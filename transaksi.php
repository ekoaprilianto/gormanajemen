            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                             <a href="tambah_transaksi.php" class="btn btn-info  btn-icon-split"><span class="icon text-white-50"><i class="fas fa-plus"></i> </span><span class="text">Tambah Transaksi</span></a><br><br>
                    ...
                    include 'koneksi.php';
                                    ...
                                    $d = mysql_query("select *from transaksi, pelanggan where transaksi.id_pelanggan = pelanggan.id_pelanggan") or die (mysql_error());
                                    ...
                                    <?php echo $arr1['nama_lapang'];?> (<?php echo $arr1['hari'];?>) <br>
                                        ...
                                        <?php } ?>
                                           ...
                                           <td>
                         <a href="hapus_transaksi.php?id=<?php echo $arr['id_transaksi'];?>"><button class="btn btn-danger  btn-icon-split" ><span class="icon text-white-50"><i class="fas fa-trash"></i> </span><span class="text">Delete</span></button></a> <a href="cetak_transaksi.php?id=<?php echo $arr['id_transaksi'];?>" target="_blank"><button class="btn btn-success  btn-icon-split" ><span class="icon text-white-50"><i class="fa fa-print " ></i></span><span class="text"> Cetak</span></button></a></td>
