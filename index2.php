                                        ...
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                               Lapang</div>
                                                <?php
                                                include 'koneksi.php';
                                                $sql1 = mysql_query("select *from lapang");
                                        ...
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Transaksi</div>
                                                 <?php
                                                include 'koneksi.php';
                                                $sql2 = mysql_query("select *from transaksi");
 ...
 for($bulan = 1;$bulan < 13;$bulan++)
{
    ...
    $query = mysql_query("select sum(total) as jumlah from transaksi where MONTH(tanggal)='$bulan'");
