            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form class="user" style="width: 50%" action="simpan_pelanggan.php" method="post">
                                        <div class="form-group">
                                            <label>Nama Pelanggan</label>
                                            <input type="text" class="form-control"
                                                placeholder="Nama Pelanggan" name="nama" >
                                        </div>
                                        <div class="form-group">
                                            <label>Alamat</label>
                                            <textarea class="form-control"
                                                id="exampleInputPassword" placeholder="Alamat" name="alamat"></textarea>
                                        </div>
                                         <div class="form-group">
